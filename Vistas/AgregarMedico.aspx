    ...
    <section id="form-body" class="flex-grow-1">
        <div class="card-container">
            <form id="form1" runat="server">
                <div class="card">
                    <h3 class="text-center">CARGAR MEDICO</h3>
                    <table class="table">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:TextBox ID="txtDniMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Nombre:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtNombreMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Apellido:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtApellidoMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Sexo:</td>
                            <td class="auto-style3">
                                <asp:DropDownList ID="ddlSexoMed" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:TextBox ID="txtNacionalidadMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Fecha de nacimiento:</td>
                            <td class="auto-style3">
                                <asp:Calendar ID="calenFechaNacMed" runat="server" CssClass="form-control-calendar"></asp:Calendar>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Provincia:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtProvinciaMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Localidad:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtLocalidadMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Dirección:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtDireccionMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:TextBox ID="txtCorreoElectronicoMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style2">Nº Telefonico:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtTelefonoMed" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="auto-style2">Horarios:</td>
                            <td class="auto-style3">
                                <asp:TextBox ID="txtHorarios" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
